...
import com.alnino.notesapp.databinding.ActivityMainBinding
import com.alnino.notesapp.db.NoteHelper
import com.alnino.notesapp.entity.Note
import com.alnino.notesapp.helper.MappingHelper
        ...
        if (result.data != null) {
            when (result.resultCode) {
                ...
                NoteAddUpdateActivity.RESULT_UPDATE -> {
                    ...
                    showSnackbarMessage("Satu item berhasil terupdate")
                }
